...
public class TopConeGrabCubeBalanceTop extends SequentialCommandGroup {

  public TopConeGrabCubeBalanceTop(Swerve s_Swerve, GrabArm _Arm) {
    
    addRequirements(s_Swerve);
    addRequirements(_Arm);
    // This will load the file "FullAuto.path" and generate it with a max velocity of 4 m/s and a max acceleration of 3 m/s^2
    // for every path in the group
    List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("TopConeGrabCubeBalanceTop", new PathConstraints(4, 8));
